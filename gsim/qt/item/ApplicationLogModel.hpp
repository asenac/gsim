...
#ifndef GSIM_QT_APPLICATIONLOGMODEL_HPP
#define GSIM_QT_APPLICATIONLOGMODEL_HPP
...
class GSIM_QT_DECLSPEC ApplicationLogModel : 
...
#endif /* GSIM_QT_APPLICATIONLOGMODEL_HPP */
