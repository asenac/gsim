...
#ifndef GSIM_QT_ENUMWIDGET_HPP
#define GSIM_QT_ENUMWIDGET_HPP
...
class GSIM_QT_DECLSPEC EnumWidget : 
    public QComboBox, public ReflectiveWidget
{
    Q_OBJECT
public:
