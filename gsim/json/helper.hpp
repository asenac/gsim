...
struct StructImpl
{
    ...
    typedef core::empl::name_of_member< S, N > name_t;
...
template < typename S >
struct StructImpl < S, typename core::empl::number_of_members< S >::type >
{
    template< typename Map >
...
struct calculate_helper
{
    typedef typename 
        // if
        core::empl::eval_if_identity< core::empl::is_bool< T >, 
            bool_helper,
        // else if
        core::empl::eval_if_identity< boost::is_arithmetic< T >, 
            arithmetic_helper< T >,
        // else if
        core::empl::eval_if_identity< boost::is_array< T >, 
            array_helper< T >,
        // else if
        core::empl::eval_if_identity< boost::is_enum< T >, 
            enum_helper< T >,
        // else if
        core::empl::eval_if_identity< core::empl::is_struct< T >, 
            struct_helper< T >,
        // else
